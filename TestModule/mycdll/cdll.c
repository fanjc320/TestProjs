...
static const struct luaL_Reg myclib1[] =
{
	{ "mysin1", mysin },
	{ "printf1", l_printf },
	{ "messagebox1", l_MessageBox },
	{ NULL, NULL }
};
...
//mycdll1必须与生成的dll名称相同,否则lua找不到
/*extern "C"*/ int __declspec(dllexport) luaopen_mycdll1(lua_State *L)
{
